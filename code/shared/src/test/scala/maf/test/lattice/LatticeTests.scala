...
abstract class IntLatticeTest[I: IntLattice, B: BoolLattice, R: RealLattice, S: StringLattice](gen: LatticeGenerator[I]) extends LatticeTest[I](gen) {
  val intLaws: Properties = {
    newProperties("Int") { p =>
      ...
      p.property("∀ a, b, c: plus(a, plus(b, c)) == plus(plus(a, b), c)") = forAll((a: I, b: I, c: I) => plus(a, plus(b, c)) == plus(plus(a, b), c))
      ...
      p.property("lt(a, ⊥) = ⊥ = lt(⊥, a)") = forAll((a: I) => lt[B](a, bottom) == BoolLattice[B].bottom && lt[B](bottom, a) == BoolLattice[B].bottom)
...
abstract class RealLatticeTest[R: RealLattice, B: BoolLattice, I: IntLattice, S: StringLattice](gen: LatticeGenerator[R])
  ...
  val realLaws: Properties = {
    newProperties("Real") { p =>
      ...
      /** Less-than operation preserves bottom */
      p.property("lt(a, ⊥) = ⊥ = lt(⊥, a)") = forAll((a: R) => lt[B](a, bottom) == BoolLattice[B].bottom && lt[B](bottom, a) == BoolLattice[B].bottom)
