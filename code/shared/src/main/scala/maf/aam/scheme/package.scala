...
package object scheme {
    export maf.aam.scheme.optimisations.SchemeAtomicEvaluation
    export maf.aam.scheme.optimisations.SchemeFunctionCallBoundary
    export maf.aam.scheme.optimisations.SchemeWideningAfterCondition
    export maf.aam.scheme.optimisations.SchemeFunctionModularAAM
