...
object SchemeOps {
  ...
  object UnaryOperator extends Enumeration {
    val IsNull, IsBoolean, IsCons, IsPointer, IsChar, IsSymbol, IsString, IsInteger, IsReal, IsVector, IsThread, IsLock, IsProcedure,
    ...
    ExactToInexact, InexactToExact, CharacterToInteger, CharacterToString, CharacterDowncase, CharacterUpcase, CharacterIsLower, CharacterIsUpper =
      Value
  }
  ...
  object BinaryOperator extends Enumeration {
    val Plus, Minus, Times, Div, Quotient, Modulo, Remainder, Expt, /* Arithmetic operations */
