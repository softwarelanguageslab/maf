...
object ContractValues {
   ...
   *
   * The `blamedPosition` represents the location of the code that violated a particular contract,
   * while `blamingPosition` represents the location of the contract that is being violated.
   */
   ...
   * </code>
   *
   * @tparam L the type of abstract value contained within the contract value
   */
