...
class IncrementalSchemeLatticePrimitives[V, A <: Address](implicit override val schemeLattice: IncrementalSchemeLattice[V, A])
    extends SchemeLatticePrimitives[V, A]:
