...
class EditText(handler: String => Unit):
    ...
    def init(): EditText =
        ...
        // Create the input
        editor = ace.edit(editorContainer, js.Dynamic.literal(mode = "ace/mode/scheme", selectionStyle = "text"))
    ...
    def setFile(contents: String): Unit =
