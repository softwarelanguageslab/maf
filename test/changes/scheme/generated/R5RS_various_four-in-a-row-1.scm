                                    ...
                                    (calculate-fps (lambda (delta-time)
                                                     (<change>
                                                        (if (not (= delta-time 0))
                                                           ...
                                                           fps)
                                                        ((lambda (x) x)
                                                           (if (<change> (not (= delta-time 0)) (not (not (= delta-time 0))))
                                                              (/ 1000 delta-time)
                                                              fps)))))
                                    (add-layer (lambda ()
                                  ...
                                  (letrec ((set-x! (lambda (new_x)
                                           ...
                                           (set-current! (lambda (new_index)
                                                           (if (let ((__or_res (>= new_index (length tiles)))) (if __or_res __or_res (< new_index 0)))
                                                              ...
                                                              (begin
                                                                 (<change>
                                                                    (set! index new_index)
                                                                    ((lambda (x) x) (set! index new_index)))
                                                                 (update-callback)))))
                                           (set-previous! (lambda ()
                                           ...
                                           (clear (lambda ()
                                                    (<change>
                                                       ...
                                                       ((lambda (x) x) (for-each (lambda (tile) (tile 'clear)) tiles)))
                                                    (<change>
                                                       ()
                                                       for-each)
                                                    (<change>
