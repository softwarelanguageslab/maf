                                                       ...
                                                       (if (eq? msg 'make-layer)
                                                          ...
                                                          (if (eq? msg 'set-background!)
                                                             ...
                                                             (if (eq? msg 'set-key-callback!)
                                                                ...
                                                                (if (<change> (eq? msg 'set-update-callback!) (not (eq? msg 'set-update-callback!)))
                                                                   (lambda (gl)
                      ...
                      (let* ((x 0)
                         ...
                         (letrec ((clear (lambda ()
                                  ...
                                  (rotate-counterclockwise (lambda ()
                                                             ...
                                                             (<change>
                                                                (rotate rotation)
                                                                ((lambda (x) x) (rotate rotation)))))
                                  (rotate (lambda (tempr)
                                            (<change>
                                               (set! rotation tempr)
                                               ((lambda (x) x) (set! rotation tempr)))
                                            (if (not (let ((__or_res (eq? 90 tempr))) (<change> (if __or_res __or_res (let ((__or_res (eq? 0 tempr))) (if __or_res __or_res (let ((__or_res (eq? 180 tempr))) (if __or_res __or_res (eq? 270 tempr)))))) ((lambda (x) x) (if __or_res __or_res (let ((__or_res (eq? 0 tempr))) (if __or_res __or_res (let ((__or_res (eq? 180 tempr))) (if __or_res __or_res (eq? 270 tempr))))))))))
                                               (begin
                                                  (<change>
                                                     ()
                                                     newline)
