...
(letrec ((atom? (lambda (x)
         ...
         (same-structure? (lambda (l1 l2)
                            (if (if (atom? l1) (atom? l2) #f)
                               #t
                               (if (<change> (let ((__or_res (atom? l1))) (if __or_res __or_res (atom? l2)) (if __or_res __or_res (atom? l2))) (not (let ((__or_res (atom? l1))) (if __or_res __or_res (atom? l2)) (if __or_res __or_res (atom? l2)))))
                                  #f
