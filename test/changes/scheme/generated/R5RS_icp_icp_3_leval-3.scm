         ...
         (eval (lambda (exp env)
                 (if (self-evaluating? exp)
                    ...
                    (if (variable? exp)
                       ...
                       (if (<change> (let ((__or_res (quoted? exp))) __or_res (if (not __or_res) __or_res (quasiquoted? exp))) (not (let ((__or_res (quoted? exp))) __or_res (if (not __or_res) __or_res (quasiquoted? exp)))))
