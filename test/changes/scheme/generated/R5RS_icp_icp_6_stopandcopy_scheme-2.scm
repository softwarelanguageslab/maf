...
(letrec ((BIAS 1000)
         ...
         (pair? (lambda (val)
                  (<change>
                     ...
                     ((lambda (x) x) (eq? (PREFIX val) PAIR-prefix)))))
         (null? (lambda (val)
                                        ...
                                        (<change>
                                           ...
                                           ((lambda (x) x)
                                              (let ((temp THE-CDRS))
                                                 (<change>
                                                    (set! THE-CDRS NEW-CDRS)
                                                    ((lambda (x) x) (set! THE-CDRS NEW-CDRS)))
                                                 (set! NEW-CDRS temp))))
                                        (let ((temp THE-CARS))
   ...
   (<change>
      ...
      ((lambda (x) x) (set-car! (car ROOT) (cdr (car (cdr ROOT))))))
   (show)
   (cons _61 _62)
   (show))