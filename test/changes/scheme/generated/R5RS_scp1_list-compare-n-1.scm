...
(letrec ((compare (lambda (lijst1 lijst2)
                    (if (let ((__or_res (null? lijst1))) (if (<change> __or_res (not __or_res)) __or_res (null? lijst2)))
                       (<change>
                          0
         ...
         (algemene-compare (lambda (lijst1 lijst2 test)
                             (<change>
                                ()
                                (car lijst1))
                             (if (<change> (let ((__or_res (null? lijst1))) (if __or_res __or_res (null? lijst2))) (not (let ((__or_res (null? lijst1))) (if __or_res __or_res (null? lijst2)))))
                                0
