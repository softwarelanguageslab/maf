                       ...
                       (let* ((drawables ())
                          ...
                          (letrec ((redraw (lambda ()
                                   ...
                                   (remove-drawable (lambda (drawable)
                                                      ...
                                                      (<change>
                                                         ()
                                                         (display (drawable 'set-on-update!)))
                                                      (redraw)))
