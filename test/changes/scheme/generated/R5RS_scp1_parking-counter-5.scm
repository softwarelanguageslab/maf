...
(letrec ((create-counter (lambda (initial)
   ...
   (if (= (parking 'level) 1)
      (if (not (parking 'full?))
         (if (= (begin (parking 'car-enters) (parking 'car-enters) (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (parking 'level)) 2)
            (if (not (parking 'empty?))
               (if (begin (parking 'car-enters) (<change> () (display parking)) (parking 'car-enters) (parking 'car-enters) (parking 'car-enters) (<change> (parking 'car-enters) ()) (<change> (parking 'car-enters) ()) (parking 'full?))
