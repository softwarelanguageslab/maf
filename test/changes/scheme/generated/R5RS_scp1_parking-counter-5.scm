...
(letrec ((create-counter (lambda (initial)
                                                                                         ...
                                                                                         (let* ((level (car lst))
                                                                                            ...
                                                                                            (<change>
                                                                                               (if (if (not (max-reached-level level index)) (>= capacity 0) #f)
                                                                                                  ...
                                                                                                  (loop (cdr lst) (- index 1)))
                                                                                               ((lambda (x) x)
                                                                                                  (if (if (<change> (not (max-reached-level level index)) (not (not (max-reached-level level index)))) (>= capacity 0) #f)
                                                                                                     index
                                                                                                     (loop (cdr lst) (- index 1))))))))))
                                                                        (loop (reverse verdieping-ctrs) nr-verdiepingen))))))
                                             (car-enters (lambda ()
   ...
   (if (= (parking 'level) 1)
      (if (not (parking 'full?))
         (if (= (begin (<change> () (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (parking 'car-enters) (parking 'car-enters) (parking 'level)) 2)
            (if (not (parking 'empty?))
               (if (begin (parking 'car-enters) (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (parking 'car-enters) (parking 'car-enters) (<change> () (display parking)) (<change> (parking 'car-enters) ()) (parking 'full?))
