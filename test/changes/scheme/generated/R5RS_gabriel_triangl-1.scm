         ...
         (attempt (lambda (i depth)
                    ...
                    (if (<change> (= depth 14) (not (= depth 14)))
                       (begin
                          ...
                          #t)
                       (if (<change> (if (= 1 (vector-ref *board* (vector-ref *a* i))) (if (= 1 (vector-ref *board* (vector-ref *b* i))) (= 0 (vector-ref *board* (vector-ref *c* i))) #f) #f) (not (if (= 1 (vector-ref *board* (vector-ref *a* i))) (if (= 1 (vector-ref *board* (vector-ref *b* i))) (= 0 (vector-ref *board* (vector-ref *c* i))) #f) #f)))
                          (begin
                             (<change>
                                ()
                                1)
