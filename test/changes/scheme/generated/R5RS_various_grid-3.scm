...
(letrec ((make-grid (lambda (start dims)
   ...
   (if (equal? (grid-ref t (__toplevel_cons 2 (__toplevel_cons 2 (__toplevel_cons 3 ())))) 0)
      (if (begin (<change> (grid-set! t 24 (__toplevel_cons 2 (__toplevel_cons 2 (__toplevel_cons 3 ())))) ((lambda (x) x) (grid-set! t 24 (__toplevel_cons 2 (__toplevel_cons 2 (__toplevel_cons 3 ())))))) (equal? (grid-ref t (__toplevel_cons 2 (__toplevel_cons 2 (__toplevel_cons 3 ())))) 24))
         (if (equal? (grid-ref t (__toplevel_cons 1 (__toplevel_cons 0 ()))) (make-vector 6 0))
            (begin
               ...
               (<change>
                  ...
                  ((lambda (x) x) (equal? (grid-ref t (__toplevel_cons 1 (__toplevel_cons 0 ()))) #t))))
            #f)
         #f)
      #f))