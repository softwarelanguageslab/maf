...
(letrec ((void (lambda ()
         ...
         (azip (lambda (list1 list2)
                 (if (<change> (if (not (pair? list1)) (pair? list2) #f) (not (if (not (pair? list1)) (pair? list2) #f)))
         ...
         (assq-remove-keys (lambda (env keys)
                             (if (<change> (not (pair? keys)) (not (not (pair? keys))))
                                env
