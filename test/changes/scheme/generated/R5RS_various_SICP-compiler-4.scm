...
(letrec ((true #t)
                            ...
                            (if (eq? linkage 'return)
                               (make-instruction-sequence
                                  ...
                                  (__toplevel_cons
                                     ...
                                     ()))
                               (if (<change> (eq? linkage 'next) (not (eq? linkage 'next)))
         ...
         (compile-procedure-call (lambda (target linkage)
                                   (let ((primitive-branch (make-label 'primitive-branch))
                                      ...
                                      (let ((compiled-linkage (if (<change> (eq? linkage 'next) (not (eq? linkage 'next)))
                                                                after-call
                                                                linkage)))
                                         (append-instruction-sequences
                                            (cons
         ...
         (modifies-register? (lambda (seq reg)
                               (<change>
                                  ...
                                  ((lambda (x) x) (memq reg (registers-modified seq))))))
         ...
         (expected-result2 (__toplevel_cons
                             ...
                             (__toplevel_cons
                                ...
                                (__toplevel_cons
                                   ...
                                   ())))))
      (if (<change> (equal? result1 expected-result1) (not (equal? result1 expected-result1)))
