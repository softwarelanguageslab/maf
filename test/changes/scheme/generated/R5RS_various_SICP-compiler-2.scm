                                    ...
                                    (__toplevel_cons
                                       ...
                                       (__toplevel_cons
                                          ...
                                          (__toplevel_cons
                                             ...
                                             ()))))
                                 (if (<change> (if (not (eq? target 'val)) (not (eq? linkage 'return)) #f) (not (if (not (eq? target 'val)) (not (eq? linkage 'return)) #f)))
                                       ...
                                       (make-instruction-sequence
                                          ...
                                          (__toplevel_cons
                                             ...
                                             (__toplevel_cons
                                                (__toplevel_cons 'goto (__toplevel_cons (__toplevel_cons 'reg (__toplevel_cons 'val ())) ()))
                                                ())))
                                       (if (if (<change> (not (eq? target 'val)) (not (not (eq? target 'val)))) (eq? linkage 'return) #f)
