                                                          ...
                                                          (if (eq? msg 'set-background!)
                                                             (lambda (mw-sb)
                                                                (<change>
                                                                   ...
                                                                   ((lambda (x) x) (set-background! mw-sb))))
                                                             (if (eq? msg 'set-key-callback!)
                                                                (lambda (eh)
                                                                   (<change>
                                                                      (set! keyboard-callback eh)
                                                                      ((lambda (x) x) (set! keyboard-callback eh))))
                                                                 ...
                                                                 (if (eq? msg 'set-x!)
                                                                    ...
                                                                    (if (eq? msg 'set-y!)
                                                                       ...
                                                                       (if (eq? msg 'get-x)
                                                                          (lambda ()
                                                                             x)
                                                                          (if (<change> (eq? msg 'get-y) (not (eq? msg 'get-y)))
                                                                             (lambda ()
                                                                                y)
                                                                             (error msg))))))))
                           ...
                           (letrec ((set-matrix! (lambda (x y value)
                                    ...
                                    (get-matrix (lambda (x y)
                                                  (<change>
                                                     ...
                                                     ((lambda (x) x) (vector-ref (vector-ref matrix-data x) y)))))
         ...
         (make-coin (lambda (x y bitmap draw-adt)
                      (letrec ((draw (lambda ()
                                       (<change>
                                          ...
                                          ((lambda (x) x) ((draw-adt 'draw-coin) coin-dispatch)))))
                          ...
                          (let ((background-layer (window 'make-layer))
                             ...
                             (letrec ((c2p-w (lambda (x)
                                                             ...
                                                             (if (< y (add1 rows))
                                                                (let ((empty-tile (make-bitmap-tile "empty.png" #f)))
                                                                   ...
                                                                   (<change>
                                                                      ...
                                                                      ((lambda (x) x) ((empty-tile 'set-x!) (c2p-w x))))
                                      ...
                                      (make-background (lambda (x y)
                                                         (<change>
                                                            ()
                                                            (display (begin (make-background-row x 1) (make-background (add1 x) y))))
                                                         (if (< x cols)
                                                            (begin
                             ...
                             (letrec ((switch (lambda ()
                                      ...
                                      (start (lambda ()
                                               (letrec ((main-loop (lambda (main-loop-n)
                                                                     (if (<change> (> main-loop-n 0) (not (> main-loop-n 0)))
                                                                        (begin
                                                                           ((window 'game-loop))
                                      ...
                                      (dispatch (lambda (msg)
                                                  (<change>
                                                     ...
                                                     ((lambda (x) x) (if (<change> (eq? msg 'start!) (not (eq? msg 'start!))) (start) #f))))))
                                dispatch))))
