...
(letrec ((create-counter (lambda (initial)
   ...
   (if (= (parking 'level) 1)
      (if (not (parking 'full?))
         (if (= (begin (<change> () parking) (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (parking 'level)) 2)
            (if (<change> (not (parking 'empty?)) (not (not (parking 'empty?))))
               (if (begin (<change> (parking 'car-enters) (parking 'car-enters)) (<change> (parking 'car-enters) (parking 'car-enters)) (parking 'car-enters) (parking 'car-enters) (parking 'car-enters) (<change> () (display 'car-enters)) (parking 'car-enters) (parking 'full?))
