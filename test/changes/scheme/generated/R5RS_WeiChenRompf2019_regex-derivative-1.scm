                           ...
                           (if (regex-null? re)
                              ...
                              (if (regex-atom? re)
                                 ...
                                 (if (match-seq re (lambda (pat1 pat2) (seq (regex-empty pat1) (regex-empty pat2))))
                                    #f
                                    (if (<change> (match-alt re (lambda (pat1 pat2) (alt (regex-empty pat1) (regex-empty pat2)))) (not (match-alt re (lambda (pat1 pat2) (alt (regex-empty pat1) (regex-empty pat2))))))
                                       #f
                                       (if (regex-rep? re) #t #f))))))))
         (d/dc (lambda (re c)
                 (<change>
                 ...
                 (if (regex-empty? re)
                    ...
                    (if (regex-null? re)
                       ...
                       (if (eq? c re)
                          ...
                          (if (regex-atom? re)
                             regex-NULL
                             (if (<change> (match-seq re (lambda (pat1 pat2) (alt (seq (d/dc pat1 c) pat2) (seq (regex-empty pat1) (d/dc pat2 c))))) (not (match-seq re (lambda (pat1 pat2) (alt (seq (d/dc pat1 c) pat2) (seq (regex-empty pat1) (d/dc pat2 c)))))))
                                #f
