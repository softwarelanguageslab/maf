                                                ...
                                                (right-rotate (lambda (node-y)
                                                                (let ((node-x (node-left node-y)))
                                                                   (<change>
                                                                      ...
                                                                      ((lambda (x) x) (node-set-left! node-y (node-right node-x))))
                                                                   (<change>
                                                                      (node-set-parent! (node-right node-x) node-y)
                                                                      ())
                                                                   (<change>
                                                                      (node-set-parent! node-x (node-parent node-y))
                                                                      ((lambda (x) x) (node-set-parent! node-x (node-parent node-y))))
                                                                   (if (<change> (not (null-tree? (node-parent node-y))) (not (not (null-tree? (node-parent node-y)))))
