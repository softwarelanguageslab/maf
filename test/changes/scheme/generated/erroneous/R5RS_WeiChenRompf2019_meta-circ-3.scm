...
(letrec ((map (lambda (f lst)
         ...
         (quote? (lambda (s-exp)
                   ...
                   (<change>
                      ...
                      ((lambda (x) x) (three-d-tagged-list? 'quote s-exp)))))
         ...
         (eval-macro (lambda (exp env)
                       (<change>
                          ...
                          ((lambda (x) x) (list 'macro (eval (macro->proc exp) env))))))
         ...
         (env-extend* (lambda (env vars values)
                        (if (<change> (pair? vars) (not (pair? vars)))
