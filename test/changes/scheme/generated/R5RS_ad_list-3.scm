                                                                          ...
                                                                          (if (= index start)
                                                                             ...
                                                                             (begin
                                                                                (<change>
                                                                                   ...
                                                                                   ((lambda (x) x) (vector-set! content (next-index index) (vector-ref content index))))
                                                                                (<change>
                                                                                   (shift-iter (prev-index index))
                                                                                   ((lambda (x) x) (shift-iter (prev-index index)))))))))
                                                      (shift-iter end))))
                                                 ...
                                                 (if (>= list-length list-size)
                                                    ...
                                                    (if (> position (+ list-length 1))
                                                       (<change>
                                                          #f
                                                          (begin
                                                             ((lambda (x) x) (set! list-length (+ 1 list-length)))
                                    ...
                                    (dispatch (lambda (m . args)
                                                (if (eq? m 'empty?)
                                                   ...
                                                   (if (eq? m 'insert)
                                                      ...
                                                      (if (<change> (eq? m 'delete) (not (eq? m 'delete)))
                                                         (delete (car args))
                                                         (if (eq? m 'retrieve)
                                                            (retrieve (car args))
                                                            (if (eq? m 'replace)
