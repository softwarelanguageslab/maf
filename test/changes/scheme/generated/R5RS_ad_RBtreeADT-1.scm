                                       ...
                                       (letrec ((make-node (lambda (item left right parent)
                                                                ...
                                                                (let ((node-x (node-left node-y)))
                                                                   ...
                                                                   (<change>
                                                                      ...
                                                                      (if (not (null-tree? (node-parent node-y)))
                                                                         (if (not (same? (node-item node-y) (node-item (node-left (node-parent node-y)))))
                                                ...
                                                (parent-is-in (lambda (node-x node-branch then-rotate other-rotate)
                                                                (let ((node-y (node-branch (node-parent (node-parent node-x)))))
                                                                   (if (<change> (equal? 'red (node-color node-y)) (not (equal? 'red (node-color node-y))))
                                                                      (begin
                                                                      ...
                                                                      (begin
                                                                         (if (<change> (if (not (null-tree? (node-branch (node-parent node-x)))) (same? (node-item node-x) (node-item (node-branch (node-parent node-x)))) #f) (not (if (not (null-tree? (node-branch (node-parent node-x)))) (same? (node-item node-x) (node-item (node-branch (node-parent node-x)))) #f)))
                                                                            (begin
                                                ...
                                                (child-is-in (lambda (node-x main-branch other-branch main-rotate other-rotate)
                                                               (let ((node-w (main-branch (node-parent node-x))))
                                                                  ...
                                                                  (if (equal? 'red (node-color node-w))
                                                                     ...
                                                                     #f)
                                                                  (if (if (<change> (eq? 'black (node-color (node-left node-w))) (not (eq? 'black (node-color (node-left node-w))))) (eq? 'black (node-color (node-right node-w))) #f)
                                                                     (begin
                                                ...
                                                (fixup-redblack-conditions (lambda (node-x)
                                                                             (if (if (not (same? (node-item node-x) (node-item content))) (equal? 'black (node-color node-x)) #f)
                                                                                (if (<change> (same? (node-item node-x) (node-item (node-left (node-parent node-x)))) (not (same? (node-item node-x) (node-item (node-left (node-parent node-x))))))
                                                                                 ...
                                                                                 (if (null-tree? node)
                                                                                    ...
                                                                                    (if (same? element (node-item node))
                                                                                       (begin
                                                                                          ...
                                                                                          #t)
                                                                                       (if (<change> (less? element (node-item node)) (not (less? element (node-item node))))
                                                               ...
                                                               (if (eq? msg 'insert)
                                                                  ...
                                                                  (if (eq? msg 'delete)
                                                                     ...
                                                                     (if (eq? msg 'lookup)
                                                                        (lookup (car args))
                                                                        (if (eq? msg 'display)
                                                                           (traverse content 'preorder (lambda (x c) (display (cons x c)) (<change> () (newline)) (newline)))
