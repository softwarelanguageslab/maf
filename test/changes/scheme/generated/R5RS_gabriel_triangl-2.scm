         ...
         (attempt (lambda (i depth)
                    ...
                    (if (= depth 14)
                       (begin
                          ...
                          #t)
                       (if (<change> (if (= 1 (vector-ref *board* (vector-ref *a* i))) #f (if (= 1 (vector-ref *board* (vector-ref *b* i))) (= 0 (vector-ref *board* (vector-ref *c* i))) #f)) (not (if (= 1 (vector-ref *board* (vector-ref *a* i))) #f (if (= 1 (vector-ref *board* (vector-ref *b* i))) (= 0 (vector-ref *board* (vector-ref *c* i))) #f))))
                          (begin
                             (<change>
                             ...
                             (<change>
                                ...
                                ((lambda (x) x) (vector-set! *board* (vector-ref *a* i) 1)))
