; Changed representation of chez-box. (source: "test/R5RS/gambit/matrix.scm")
...
(define (chez-box x) (<change> (cons x '()) (cons 'box x)))
(define (chez-unbox x) (<change> (car x) (cdr x)))
(define (chez-set-box! x y) (<change> (set-car! x y) (set-cdr! x y)))
